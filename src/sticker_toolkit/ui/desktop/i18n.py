...
_EN = {
    ...
    "label.background_preset": "Preset Background Color:",
    "label.tolerance": "Tolerance:",
    "mode.sheet": "4×4 Sticker Sheet",
    "mode.batch": "WeChat 16-image Batch",
    "mode.line_animated": "LINE Animated",
    "mode.main_cover": "Main / Cover",
    "platform.line": "LINE",
    ...
    "button.generate_covers": "Generate Main / Cover",
    ...
    "background_preset.offwhite": "Off-white",
    "background_preset.darkblue": "Dark Blue",
    "background_preset.custom": "Custom…",
    ...
    "dialog.choose_cover_source": "Choose Main / Cover Source Image",
    ...
    "dialog.completed.covers": "Main / Cover assets were exported successfully.",
    ...
    "summary.cover_files": "Main / Cover files: main.png, tab.png, cover.png, panel_icon.png",
    ...
    "progress.read_cover": "Reading Main / Cover source image",
    ...
    "progress.cover_assets": "Creating Main / Cover assets",
...
_ZH_TW = {
    **_EN,
    ...
    "label.background_preset": "預設背景色：",
    "label.tolerance": "容差：",
    "mode.sheet": "4×4 貼圖組圖",
    "mode.batch": "WeChat 16 張單圖 Batch",
    "mode.line_animated": "LINE 動圖",
    "mode.main_cover": "Main / Cover（封面）",
    "platform.both": "LINE＋WeChat",
    ...
    "button.start": "開始處理",
    "button.generate_covers": "產生 Main / Cover",
    ...
    "background_preset.offwhite": "米白",
    "background_preset.darkblue": "深藍",
    "background_preset.custom": "自訂…",
    ...
    "dialog.choose_cover_source": "選擇 Main / Cover 來源圖片",
    ...
    "dialog.completed.covers": "Main / Cover 素材已成功輸出。",
    "dialog.failed": "處理失敗",
    ...
    "summary.cover_files": "Main / Cover 檔案：main.png、tab.png、cover.png、panel_icon.png",
    "progress.prepare": "準備處理",
    "progress.read_batch": "正在讀取批次圖片",
    "progress.batch_item": "正在處理批次圖片 {index} / {total}",
    "progress.read_image": "正在讀取圖片",
    "progress.read_cover": "正在讀取 Main / Cover 來源圖片",
    ...
    "progress.cover_assets": "正在產生 Main / Cover 素材",
...
_ZH_CN.update(
    {
        ...
        "label.columns": "列数：",
        "label.background_color": "背景色：",
        "label.background_preset": "预设背景色：",
        "label.tolerance": "容差：",
        "mode.sheet": "4×4 贴图组图",
        "mode.batch": "WeChat 16 张单图 Batch",
        "mode.line_animated": "LINE 动图",
        "mode.main_cover": "Main / Cover（封面）",
        "platform.both": "LINE＋WeChat",
        ...
        "button.start": "开始处理",
        "button.generate_covers": "生成 Main / Cover",
        ...
        "background_preset.offwhite": "米白",
        "background_preset.darkblue": "深蓝",
        "background_preset.custom": "自定义…",
        ...
        "dialog.choose_cover_source": "选择 Main / Cover 来源图片",
        ...
        "dialog.completed.covers": "Main / Cover 素材已成功输出。",
        "dialog.failed": "处理失败",
        ...
        "summary.cover_files": "Main / Cover 文件：main.png、tab.png、cover.png、panel_icon.png",
        "progress.prepare": "准备处理",
        "progress.read_batch": "正在读取批次图片",
        "progress.batch_item": "正在处理批次图片 {index} / {total}",
        "progress.read_image": "正在读取图片",
        "progress.read_cover": "正在读取 Main / Cover 来源图片",
        ...
        "progress.cover_assets": "正在生成 Main / Cover 素材",
...
_PROGRESS_KEYS = {
    ...
    "正在產生 Main / Cover 素材": "progress.cover_assets",
