...
_EN = {
    ...
    "validation.platform": "Please select LINE, WeChat, or LINE + WeChat.",
...
_ZH_TW = {
    **_EN,
    ...
    "validation.platform": "請選擇 LINE、WeChat 或 LINE＋WeChat。",
...
_ZH_CN.update(
    {
        ...
        "validation.platform": "请选择 LINE、WeChat 或 LINE＋WeChat。",
